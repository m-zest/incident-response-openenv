...
.term-welcome .tiers{margin-top:20px;display:flex;justify-content:center;gap:10px;flex-wrap:wrap}
.tier-tag{font-size:11px;font-weight:600;padding:5px 14px;border-radius:20px;border:1px solid var(--border)}
